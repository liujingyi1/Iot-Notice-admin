...
public class OkHttpUtil {
     ...
     * @return
     */
    private static StringBuffer getQueryString(String url,Map<String,Object> queries){
    ...
    public static String postFormParams(String url, Map<String, Object> params) {
        ...
        if (params != null && params.keySet().size() > 0) {
            for (String key : params.keySet()) {
                builder.add(key, Objects.toString(params.get(key), null));
            }
        }
        Request request = new Request.Builder()
                .url(url)
